...
pick_amt,currency_denomi,deposit_type,acc_no,cheque_no,receipt_no,hcl_slip_no,cheque_amt,bank_name,account_no,remarks,created_by,created_date,status) VALUES('" . $client_id . "','" . $cust_id . "','" . $mandate . "','" . $in_time . "','" .
	...
	//Mapp Cahvan to Service
		...
		$service_no = $_POST['service_no'];$vehicle1='';
		$gun_cnt = 0; $drv_cnt = 0; $ce_cnt = 0; $mbc_cnt = 0; $ldr_cnt = 0;
		$cv = $_POST['cv'];
		//$cashvan = $_POST['cashvan'];
		
		if($_POST['vehicle_type_tra']=='Hired')
		{
		...
		if(isset($_POST['loader'])){
			...
			if(isset($loadyy)){
				$sel_ld = mysqli_query($writeConnection,"Select name,crew_id from dcv_crew where service_id = '".$_POST['service_name']."' and vehicle_id='".$cv."' and desig='loader' and status='Y'");
		...
		$up_ser = "Update cashvan_services set vehicle_id ='".$vehicle1."',crew_members='".$crew1."',cashvan_type='".$process_type."',rbi_guide='".$rbi_guide_hired."',vehicle_model='".$vehicle_model_hired."',ac_or_nonac='".$acornon."',update_by='".$user_name."',update_time=now() where service_id='".$_POST['service_name']."' and status='Y' ";
		$excs = mysqli_query($writeConnection,$up_ser);
		
		//echo "Update vantrans_details set vehicle_no='".$cashvan."',crew_members='".$crew."',cashvan_type='".$process_type."',rbi_guide='".$rbi_guide_hired."',vehicle_model='".$vehicle_model_hired."',ac_or_nonac='".$acornon."'  where service_id='".$_POST['service_name']."'  and trans_date='".date('Y-m-d')."'"; die;
		
		//$upda_trans = mysqli_query($writeConnection,"Update vantrans_details set vehicle_no='".$cashvan."',crew_members='".$crew."',cashvan_type='".$process_type."',rbi_guide='".$rbi_guide_hired."',vehicle_model='".$vehicle_model_hired."',ac_or_nonac='".$acornon."'  where service_id='".$_POST['service_name']."'  and trans_date='".date('Y-m-d')."'");
	...
	//Assign Vans
		...
		$gun_cnt = 0; $drv_cnt = 0; $ce_cnt = 0; $ldr_cnt = 0;
	...
	// Cash Van Trans Information
		...
		//echo $service_type_check; exit;
	
		$from_date=mysqli_real_escape_string($writeConnection,date('Y-m-d',strtotime($_POST['from_date'])));
		$to_date = mysqli_real_escape_string($writeConnection,date('Y-m-d',strtotime($_POST['to_date'])));
		$from_location=mysqli_real_escape_string($writeConnection,$_POST['from_location']);
		$to_location=mysqli_real_escape_string($writeConnection,$_POST['to_location']);
		$time_in=mysqli_real_escape_string($writeConnection,$_POST['time_in']);
		$time_out=mysqli_real_escape_string($writeConnection,$_POST['time_out']);
		/* --additional info */
		$extra_ot=mysqli_real_escape_string($writeConnection,$_POST['extra_ot']);
		$contactperson=mysqli_real_escape_string($writeConnection,$_POST['contact_person']);
		$contactnumber =mysqli_real_escape_string($writeConnection,$_POST['contact_number']);
		$emailid =mysqli_real_escape_string($writeConnection,$_POST['emailid']);
		$field1 =mysqli_real_escape_string($writeConnection,$_POST['field1']);
		$field2 =mysqli_real_escape_string($writeConnection,$_POST['field2']);
		/* additional info */
		/* extra fields */
		$intercity=mysqli_real_escape_string($writeConnection,$_POST['intercity']);
		$location=mysqli_real_escape_string($writeConnection,$_POST['location']);
		$frombranchcode =mysqli_real_escape_string($writeConnection,$_POST['from_branchcode']);
		$tobranchcode =mysqli_real_escape_string($writeConnection,$_POST['to_branchcode']);
		$oneway =mysqli_real_escape_string($writeConnection,$_POST['oneway_twoway']);
		$airport_parkingcharges =mysqli_real_escape_string($writeConnection,$_POST['airport_parkingcharges']);
		$costofoperation =mysqli_real_escape_string($writeConnection,$_POST['costofoperation']);
		$category =mysqli_real_escape_string($writeConnection,$_POST['category']);
		$additionalloaders =mysqli_real_escape_string($writeConnection,$_POST['additional_loaders']);
		/* extrafields */
	
		$total_time=mysqli_real_escape_string($writeConnection,$_POST['total_time']);
		$ot_hours=mysqli_real_escape_string($writeConnection,$_POST['ot_hours']);
		$start_kms=mysqli_real_escape_string($writeConnection,$_POST['start_kms']);
		$end_kms=mysqli_real_escape_string($writeConnection,$_POST['end_kms']);
		$total_kms=mysqli_real_escape_string($writeConnection,$_POST['total_kms']);
	
	
		$toll_tax=mysqli_real_escape_string($writeConnection,$_POST['toll_tax']);
		$service_category=mysqli_real_escape_string($writeConnection,$_POST['service_category']);
		$parking_charges=mysqli_real_escape_string($writeConnection,$_POST['parking_charges']);
		$bill_branch=mysqli_real_escape_string($writeConnection,$_POST['bill_branch']);
		$pickup_amount=mysqli_real_escape_string($writeConnection,$_POST['pickup_amount']);
		$delivery_amount = mysqli_real_escape_string($writeConnection,$_POST['delivery_amount']);
		$vault_status = mysqli_real_escape_string($writeConnection,$_POST['vault_status']); 
		$night_stay=mysqli_real_escape_string($writeConnection,$_POST['night_stay']);
		$no_trips=mysqli_real_escape_string($writeConnection,$_POST['no_trips']);
		//modified for vantrans
		$other_remarks_vt=mysqli_real_escape_string($writeConnection,$_POST['other_remarks']);
		//
		$remarks=mysqli_real_escape_string($writeConnection,$_POST['remarks']);
		$client_acc_no=mysqli_real_escape_string($writeConnection,$_POST['client_acc_no']);
		$no_cheques=mysqli_real_escape_string($writeConnection,$_POST['no_cheques']);
		$permit_paid=mysqli_real_escape_string($writeConnection,$_POST['permit_paid']);
		$additional_charges=mysqli_real_escape_string($writeConnection,$_POST['additional_charges']);
		$tele_charge=mysqli_real_escape_string($writeConnection,$_POST['tele_charge']);
		$insurance =mysqli_real_escape_string($writeConnection,$_POST['insurance']);
		$crew_members=mysqli_real_escape_string($writeConnection,$_POST['crew_members']);
		$additional_crew=mysqli_real_escape_string($writeConnection,$_POST['additional_crew']);
		$clients = '';$client_acc='';$locs='';$serv_cat='';$pick_amt='';$cheq_no='';$rems='';
		...
		//{`
			...
			// echo '<br>';
			// echo 'secondary vehNo-------';
			// echo $_POST['vec__reg_no_asi'];
		...
		//{
			...
			$rbi_guide_hired=$_POST['rbi_guide'];
...
if($pid == 'Daily_upload'){	
    ...
    if(mysqli_num_rows($sel_dcv) > 0){
        while($dcv_rw = mysqli_fetch_assoc($sel_dcv)){
            ...
            foreach($vans as $key => $vanid){
                //echo "Select sid from vantrans_details where service_type='DCV' and trans_date='".date('Y-m-d')."' and service_id = '".$dcv_rw['service_id']."' and vehicle_no='".$vanid."' and status='Y' ";
                ...
                if(mysqli_num_rows($chk_dcv) == '0'){
                    ...
                    $get_hd = mysqli_query($readConnection,"Select * from cashvan_services where service_type='DCV'  and service_id = '".$dcv_rw['service_id']."' and vehicle_id='".$vanid."' and status='Y' and cashvan_type!='' ");
                     $res_hid=mysqli_fetch_array($get_hd);
                     
                    $ins_dcv = "insert into vantrans_details(service_id,trans_date,vehicle_no,crew_members,service_type,cashvan_type,rbi_guide,vehicle_model,ac_or_nonac,status,created_by,created_date) values('".$dcv_rw['service_id']."','".date('Y-m-d')."','".$vanid."','".$crew[$key]."','DCV','".$res_hid['cashvan_type']."','".$res_hid['rbi_guide']."','".$res_hid['vehicle_model']."','".$res_hid['ac_or_nonac']."','Y','".$user_name."',now())";
                    //echo $ins_dcv = "insert into vantrans_details(service_id,trans_date,vehicle_no,crew_members,service_type,status,created_by,created_date) values('".$dcv_rw['service_id']."','".date('Y-m-d')."','".$vanid."','".$crew[$key]."','DCV','Y','".$user_name."',now())"; die;
    ...
    if(isset($_POST['submit1'])){
        //print_r($_POST['service_codes']); die;
...
//echo "hi"; die;
            ...
            if($ty_row['service_type'] == 'DCV'){
                //echo "Select service_id,vehicle_id,crew_members from cashvan_services where service_type='DCV' and status='Y' and vehicle_id!='0' and vehicle_id!='' and service_code='".$vals."' "; die;
                ...
                if(mysqli_num_rows($sel_dcv) > 0){
                    while($dcv_rw = mysqli_fetch_assoc($sel_dcv)){
                        ...
                        $crew = explode("/",$dcv_rw['crew_members']);
                        foreach($vans as $key => $vanid){
                            //echo "Select * from vantrans_details where service_type='DCV'  and service_id = '".$dcv_rw['service_id']."' and vehicle_no='".$vanid."' and status='Y' order by sid desc limit 1"; die;
                                //$get_hd = mysqli_query($readConnection,"Select * from vantrans_details where service_type='DCV'  and service_id = '".$dcv_rw['service_id']."' and vehicle_no='".$vanid."' and status='Y' and cashvan_type!='' order by sid desc limit 1");
                                $get_hd = mysqli_query($readConnection,"Select * from cashvan_services where service_type='DCV'  and service_id = '".$dcv_rw['service_id']."' and vehicle_id='".$vanid."' and status='Y' and cashvan_type!='' ");
                                $res_hid=mysqli_fetch_array($get_hd);
            ...
            //$ex1 = mysqli_query($readConnection,$sel_qu);
            //echo $sel_qu;die;
            //if(mysqli_num_rows($ex1) == 0){
                ...
                //$sel_cvr = mysqli_query($readConnection,"Select sid from vantrans_details where trans_date='".date('Y-m-d')."' and status='Y' and service_type='".$ty_row['service_type']."' and  service_id='".$ty_row['service_id']."'");
        ...
        //mysqli_close($conn);
        header("Location:../?pid=Daily_upload&nav=2_1_5&totals=$totals1&dtotal=$dcv_total");exit;
    } 
    }
