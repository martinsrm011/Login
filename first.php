...
$sql_dep = mysqli_query($readConnection,"SELECT * FROM daily_deposit WHERE dep_id='$dep_id'");
$res_dep = mysqli_fetch_assoc($sql_dep);
        ...
        <div class="col-md-12 col-sm-11">
            <div class="portlet">
                ...
                <div class="form-group col-sm-12">
					...
					IF($login_regoin !='' ){
					$sql_ce = mysqli_query($readConnection,"SELECT a.ce_name, a.ce_id, lo.location FROM shop_cemap AS c INNER JOIN  radiant_ce AS a 
            ...
            <div class="clear"></div>-->
                ...
                ?>
                                ...
                                <div class="form-group col-sm-8" id="acc_ids" style="display:none;">
									...
									//$part1 and 
										if($dep_id!='') {
										$qub=mysqli_query($readConnection,"select acc_id, bank_name, branch_name, account_no from bank_master where  status='Y' order by bank_name,branch_name,account_no");
										...
										//$qub=mysqli_query($sqlb);
										IF(mysqli_num_rows($qub) > 0){
										while($rb=mysqli_fetch_array($qub)) { ?>
